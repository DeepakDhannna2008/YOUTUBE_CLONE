...
!y("Android") || ua() || ta();
ua();
var Ba = y("Safari") && !(ua() || y("Coast") || y("Opera") || y("Edge") || y("Edg/") || y("OPR") || ta() || y("Silk") || y("Android")) && !(y("iPhone") && !y("iPod") && !y("iPad") || y("iPad") || y("iPod"));
var Ca = {},
    Da = null;
...
const Ia = "function" === typeof Uint8Array.prototype.slice;
let Ja;
...
var Oa = class {
        ...
        clone() {
            return Ka(this.i, this.l, this.j - this.l)
        }
        clear() {
            this.i = null;
            this.h = this.j = this.l = 0;
...
var Sa = class {
    constructor(a) {
        ...
        this.Z = c;
        this.h = Ka(a, void 0, void 0, this.u);
        this.o = this.h.h;
...
function Va(a, b, c) {
    if (null != a) return "object" === typeof a ? Ta && a instanceof Uint8Array ? c(a) : Wa(a, b, c) : b(a)
}

function Wa(a, b, c) {
    if (Array.isArray(a)) {
        var d = Array(a.length);
        for (var e = 0; e < a.length; e++) d[e] = Va(a[e], b, c);
        Array.isArray(a) && a.U && Xa(d);
        return d
    }
    d = {};
    for (e in a) d[e] = Va(a[e], b, c);
    return d
}
const Ya = a => "number" === typeof a ? isFinite(a) ? a : String(a) : a,
    Za = a => new Uint8Array(a),
    $a = a => a,
    ab = {
        U: {
            value: !0,
...
function Xa(a) {
    Array.isArray(a) && !Object.isFrozen(a) && Object.defineProperties(a, ab);
    return a
};
...
class db {
    constructor(a, b) {
        ...
        if (0 < this.i.length) {
            for (a = 0; a < this.i.length; a++) {
                b = this.i[a];
                const c = b[0];
                this.h[c.toString()] = new eb(c, b[1])
            }
            this.l = !0
        }
    }
    ...
    values() {
        const a = [],
            b = bb(this);
        b.sort();
        for (let c = 0; c < b.length; c++) a.push(cb(this, this.h[b[c]]));
        return new fb(a)
    }
    forEach(a, b) {
        const c = bb(this);
    ...
    set(a, b) {
        const c = new eb(a);
        this.j ? (c.h = b, c.value = b.v(!1)) : c.value = b;
        this.h[a.toString()] = c;
        this.l = !1;
        return this
    }
    get(a) {
        if (a = this.h[a.toString()]) return cb(this, a)
    }
    has(a) {
...
function B(a, b, c) {
    ...
    if (c)
        for (b = 0; b < c.length; b++) a = c[b], a < this.m ? (a += this.l, (d = this.i[a]) ? Xa(d) : this.i[a] = hb) : (ib(this), (d = this.j[a]) ? Xa(d) : this.j[a] = hb)
}
const hb = Object.freeze(Xa([]));
...
function kb(a, b, c, d = !1) {
    d || b >= a.m ? (ib(a), a.j[b] = c) : a.i[b + a.l] = c
}

function mb(a, b, c, d, e = !1) {
    if (-1 === c) return null;
    a.h || (a.h = {});
    !a.h[c] && (e = C(a, c, e), d || e) && (a.h[c] = new b(e));
    return a.h[c]
}
...
B.prototype.v = function(a) {
    if (this.h)
        for (let b in this.h) {
            const c = this.h[b];
            if (Array.isArray(c))
                for (let d = 0; d < c.length; d++) c[d] && c[d].v(a);
            else c && c.v(a)
        }
    return this.i
};
...
function ob(a) {
    ...
    for (let g = a.length; g--;) {
        ...
        if (Array.isArray(h)) {
            var e = h;
            Array.isArray(h) && h.U && !h.length ? h = null : h = ob(h);
            h != e && (d = !0)
        } else if (Ua(h)) {
            a: {
                var f = h;e = {};
                ...
                for (let l in f) {
                    ...
                    if (Array.isArray(n)) {
                        let r = n;
                        Array.isArray(n) && n.U && !n.length ? n = null : n = ob(n);
                        n != r && (k = !0)
                    }
                    null != n ? e[l] = n : k = !0
                }
    ...
    if (c) {
        ...
        for (let f in c) {
            ...
            if (g) {
                ...
                if (Array.isArray(g)) {
                    if (g.length)
                        for (d = nb(a, g[0].constructor, e), e = 0; e < Math.min(d.length, g.length); e++) pb(d[e], g[e])
                } else if (g instanceof db) {
                    if (g.j) {
                        const h = lb(a, e, g.j);
                        g.forEach((k, l) => pb(h.get(l), k))
                    }
                } else(d = mb(a, g.constructor, e, 0, d)) && pb(d, g)
            }
        }
    }
};
...
function qb(a, b) {
    ...
    if (!b.Z) {
        var d = b.h.i;
        b = b.h.h;
        c = c === b ? Ja || (Ja = new Uint8Array(0)) : Ia ? d.slice(c, b) : new Uint8Array(d.subarray(c, b));
...
var sb = "client_dev_mss_url client_dev_regex_map client_dev_root_url expflag jsfeat jsmode client_rollout_override".split(" ");
        ...
        for (m = 0; 80 > m; m++) {
            if (40 > m)
                if (20 > m) {
                    var N = z ^ v & (w ^ z);
                    var La = 1518500249
                } else N = v ^ w ^ z, La = 1859775393;
            else 60 > m ? (N = v & w | z & (v | w), La = 2400959708) : (N = v ^ w ^ z, La = 3395469782);
            N = ((r << 5 | r >>> 27) & 4294967295) + N + ca + La + t[m] & 4294967295;
            ca = z;
            z = w;
...
function ub(a, b, c) {
    ...
    return d && a && b ? [b, vb(rb(d), a, c || null)].join(" ") : null
}
...
E.prototype.set = function(a, b, c) {
    let d, e, f, g = !1,
        h;
    "object" === typeof c && (h = c.Fa, g = c.Ga || !1, f = c.domain || void 0, e = c.path || void 0, d = c.aa);
...
function yb() {
    return !!xb.FPA_SAMESITE_PHASE2_MOD || !1
}

function zb(a, b, c, d) {
    (a = p[a]) || (a = (new E).get(b));
    return a ? ub(a, c, d) : null
}

function Ab() {
    var a = [],
        b = rb(String(p.location.href));
    const c = [];
    var d = p.__SAPISID || p.__APISID || p.__3PSAPISID || p.__OVERRIDE_SID;
    yb() && (d = d || p.__1PSAPISID);
    if (d) var e = !0;
    else e = new E, d = e.get("SAPISID") || e.get("APISID") || e.get("__Secure-3PAPISID") || e.get("SID"), yb() && (d = d || e.get("__Secure-1PAPISID")), e = !!d;
    e && (d = (e = b = 0 == b.indexOf("https:") || 0 == b.indexOf("chrome-extension:") || 0 == b.indexOf("moz-extension:")) ? p.__SAPISID : p.__APISID, d || (d = new E, d = d.get(e ? "SAPISID" : "APISID") || d.get("__Secure-3PAPISID")),
        (e = d ? ub(d, e ? "SAPISIDHASH" : "APISIDHASH", a) : null) && c.push(e), b && yb() && ((b = zb("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && c.push(b), (a = zb("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && c.push(a)));
...
var Eb = new Bb(() => new Fb, a => a.reset());
class Fb {
    constructor() {
    ...
    if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
        ...
        if (null ==
            ...
            if (a.constructor && a.constructor instanceof Function) {
                ...
                else if (c = a.constructor, Ob[c]) c = Ob[c];
                else {
                    c = String(c);
                    if (!Ob[c]) {
                        var f = /function\s+([^\(]+)/m.exec(c);
                        Ob[c] = f ? f[1] : "[Anonymous]"
                    }
                    c = Ob[c]
                }
    ...
    if (0 == a.h)
        if (a.j) {
            ...
            if (c.i) {
                ...
                e && (0 == c.h && 1 == d ? Yb(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : Zb(c), $b(c, e, 3, b)))
            }
            a.j = null
        } else G(a, 3, b)
}
...
function G(a, b, c) {
    if (0 == a.h) {
        ...
        g || (a.u = c, a.h = b, a.j = null, bc(a), 3 != b || c instanceof Xb || dc(a, c))
    }
}
...
F.prototype.H = function() {
    for (var a; a = Zb(this);) $b(this, a, this.h, this.u);
    this.o = !1
};
...
H.prototype.J = function(a) {
    ...
    if (b) {
        var c = this.i[b];
        if (0 != this.o) this.m.push(a), this.h[a + 1] = fa;
        else {
            if (c) {
...
H.prototype.clear = function(a) {
    if (a) {
        var b = this.i[a];
        b && (b.forEach(this.J, this), delete this.i[a])
...
var ic = ["notification/convert_endpoint_to_url"],
    jc = ["notification/record_interactions"],
    kc = ["notification_registration/set_registration"];
var lc = a => self.btoa(String.fromCharCode.apply(null, Array.from(new Uint8Array(a)))).replace(/\+/g, "-").replace(/\//g, "_");
var mc = ["notifications_register", "notifications_check_registration"];
...
function I(a, b) {
    ...
    c.key = a;
    c.value = b;
    return pc().then(d => new Promise((e, f) => {
        try {
...
function J(a) {
    const b = new nc("Error accessing DB");
    return pc().then(c => new Promise((d, e) => {
        try {
...
function pc() {
    return oc ? Promise.resolve(oc) : new Promise((a, b) => {
        const c = self.indexedDB.open("swpushnotificationsdb");
        c.onerror = b;
        c.onsuccess = () => {
            const d = c.result;
            if (d.objectStoreNames.contains("swpushnotificationsstore")) oc = d, a(oc);
            else return self.indexedDB.deleteDatabase("swpushnotificationsdb"), pc()
        };
...
function uc(a) {
    return `/youtubei/v1/${tc(a)}`
};
var vc = class extends B {
    constructor(a) {
        super(a)
    }
};
var wc = class extends B {
    constructor(a) {
        super(a)
    }
};
...
var xc, yc;
const zc = p.window,
    K = (null === (xc = null === zc || void 0 === zc ? void 0 : zc.yt) || void 0 === xc ? void 0 : xc.config_) || (null === (yc = null === zc || void 0 === zc ? void 0 : zc.ytcfg) || void 0 === yc ? void 0 : yc.data_) || {};
u("yt.config_", K);
...
let Cc = 0;
u("ytDomDomGetNextId", q("ytDomDomGetNextId") || (() => ++Cc));
const Dc = [];
...
function Vc(a, b) {
    ...
    if (b = b.urlParams) b[c] && delete b[c], a = Rc(a, b || {}, !0);
    return a
}
...
function Wc(a, b) {
    ...
    if (!(a = e) && (a = f)) {
        ...
        a = !f
    }!Tc && a && "POST" != b.method && (Tc = !0, Gc(Error("AJAX request with postData should use POST")));
    return e
};
...
const Xc = Bc("initial_gel_batch_timeout", 2E3),
    Yc = Math.pow(2, 16) - 1;
let R = void 0,
    Zc = 0,
    $c = 0,
    ad = 0,
    bd = !0;
const cd = p.ytLoggingTransportGELQueue_ || new Map,
    dd = p.ytLoggingTransportTokensToCttTargetIds_ || {};

function ed(a, b) {
    if ("log_event" === a.endpoint) {
        var c = "";
        a.M ? c = "visitorOnlyApprovedKey" : a.B && (dd[a.B.token] = fd(a.B), c = a.B.token);
        var d = cd.get(c) || [];
        cd.set(c, d);
        d.push(a.payload);
        b && (R = new b);
        a = Bc("tvhtml5_logging_max_batch") || Bc("web_logging_max_batch") || 100;
        b = Q();
        d.length >= a ? gd({
            writeThenSend: !0
        }, O("flush_only_full_queue") ? c : void 0) : 10 <= b - ad && (hd(), ad = b)
    }
}
    ...
    new F(c => {
        ...
        if (R && R.isReady())
            if (void 0 !== b) {
                ...
                jd(d, c, a);
                cd.delete(b)
            } else jd(cd, c, a), cd.clear();
        else hd(), c()
    })
}

function hd() {
    O("web_gel_timeout_cap") && !$c && ($c = Ic(() => {
        gd({
            writeThenSend: !0
        })
    }, 6E4));
    window.clearTimeout(Zc);
    let a = M("LOGGING_BATCH_TIMEOUT", Bc("web_gel_debounce_ms", 1E4));
    O("shorten_initial_gel_batch_timeout") && bd && (a = Xc);
    Zc = Ic(() => {
        gd({
            writeThenSend: !0
        })
...
function nd(a, b, c) {
    ...
    !c && (b = M("EVENT_ID", void 0)) && ((c = M("BATCH_CLIENT_COUNTER", void 0) || 0) || (c = Math.floor(Math.random() * Yc / 2)), c++, c > Yc && (c = 1), L("BATCH_CLIENT_COUNTER", c), a.serializedClientEventId = {
        serializedEventId: b,
...
const pd = p.ytLoggingGelSequenceIdObj_ || {};
...
function qd(a, b, c, d = {}) {
    ...
    O("log_sequence_info_on_gel_web") && d.da && (a = e.context, b = d.da, pd[b] = b in pd ? pd[b] + 1 : 0, a.sequence = {
        index: pd[b],
        groupKey: b
    }, d.Aa && delete pd[d.da]);
    (d.Ha ? id : ed)({
...
function ld() {
    return {
        ...
        ia: M("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
        ja: M("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
        innertubeContextClientVersion: M("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
        la: M("INNERTUBE_CONTEXT_HL", void 0),
        ka: M("INNERTUBE_CONTEXT_GL", void 0),
        ma: M("INNERTUBE_HOST_OVERRIDE", void 0) || "",
        oa: !!M("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
        na: !!M("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
...
function kd(a) {
    ...
    if ("WEB" === f || "MWEB" === f || 1 === f || 2 === f) {
        if (!O("web_include_display_mode_killswitch")) {
            ...
            b.client.mainAppWebInfo.webDisplayMode = rd()
        }
    } else if (g = b.client.clientName, ("WEB_REMIX" === g || 76 === g) && !O("music_web_display_mode_killswitch")) {
        var h;
        b.client.ca = null != (h = b.client.ca) ? h : {};
        b.client.ca.webDisplayMode = rd()
    }
    a.appInstallData &&
    ...
    a: {
        if (h = ud()) {
            a = sd[h.type || "unknown"] || "CONN_UNKNOWN";
            h = sd[h.effectiveType || "unknown"] || "CONN_UNKNOWN";
    ...
    O("web_log_effective_connection_type") &&
        (a = ud(), a = null !== a && void 0 !== a && a.effectiveType ? td.hasOwnProperty(a.effectiveType) ? td[a.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, a && (b.client.effectiveConnectionType = a));
    a = Object;
    h = a.assign;
    g = b.client;
    e = M("DEVICE", "");
    f = {};
    for (const [k, l] of Object.entries(Qc(e))) e = k, c = l, "cbrand" === e ? f.deviceMake = c : "cmodel" === e ? f.deviceModel = c : "cbr" === e ? f.browserName = c : "cbrver" === e ? f.browserVersion = c : "cos" === e ? f.osName = c : "cosver" === e ? f.osVersion = c : "cplatform" === e && (f.platform = c);
    b.client = h.call(a,
        g, f);
    return b
}
...
function wd(a, b, c) {
    ...
    (b = c.wa || M("AUTHORIZATION")) || (a ? b = `Bearer ${q("gapi.auth.getToken")().va}` : b = Ab());
...
function Bd() {
    ...
    throw new nc("Datasync ID not set", "unknown");
};
...
var U = class extends nc {
        constructor(a, b = {}, c = Ed[a], d = Fd[a], e = Gd[a]) {
...
const Jd = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
...
function Kd(a, b, c, d) {
    ...
    if (Ba && "UnknownError" === e.name) return new U("QUOTA_MAYBE_EXCEEDED", {
        objectStoreNames: c,
        dbName: b
    });
    if (e instanceof Id) return new U("MISSING_INDEX", {
        dbName: b,
        dbVersion: d,
        objectStore: e.objectStore,
        index: e.index
    });
    if ("InvalidStateError" === e.name && Jd.some(f => e.message.includes(f))) return new U("EXECUTE_TRANSACTION_ON_CLOSED_DB", {
        objectStoreNames: c,
        dbName: b
    });
...
function Pd(a, b, c, d, e) {
    try {
        ...
        f instanceof V ? Qd(a, b, f, d, e) : d(f)
    } catch (f) {
        e(f)
    }
}
...
var V = class {
    ...
    static all(a) {
        return new V(new Nd((b, c) => {
            ...
            let e = a.length;
            0 === e && b(d);
            for (let f = 0; f < a.length; ++f) Od(a[f]).then(g => {
                d[f] = g;
                e--;
                0 === e && b(d)
            }).catch(g => {
    ...
    then(a, b) {
        const c = null !== a && void 0 !== a ? a : Md,
            d = null !== b && void 0 !== b ? b : Ld;
        return new V(new Nd((e, f) => {
            "PENDING" === this.state.status ? (this.h.push(() => {
                Pd(this, this, c, e, f)
            }), this.onRejected.push(() => {
                Rd(this, this, d, e, f)
            })) : "FULFILLED" === this.state.status ? Pd(this, this, c, e, f) : "REJECTED" === this.state.status && Rd(this, this, d, e, f)
        }))
    } catch (a) {
    ...
    return D(a, function*() {
        ...
        for (; !h;) {
            ...
            try {
                ...
                var k = d;
                const r = new Vd(n),
                    t = yield Wd(r, k), m = Math.round(Q());
                Xd(this, l, m, g, void 0, b.join(), e);
                return t
            } catch (n) {
                k = Math.round(Q());
                const r = Kd(n, this.h.name, b.join(), this.h.version);
                if (r instanceof U && !r.h || g >= f) Xd(this,
...
function Xd(a, b, c, d, e, f, g) {
    b = c - b;
    e ? (e instanceof U && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && Ad("QUOTA_EXCEEDED", {
        dbName: Dd(a.h.name),
        objectStoreNames: f,
        transactionCount: a.transactionCount,
        transactionMode: g.mode
    }), e instanceof U && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), Ad("TRANSACTION_UNEXPECTEDLY_ABORTED", {
        objectStoreNames: f,
        transactionDuration: b,
        transactionCount: a.transactionCount,
        dbDuration: c
    }), a.i = !0), $d(a, !1, d, f, b, g.tag), zd(e)) : $d(a, !0, d, f, b, g.tag)
}

function $d(a, b, c, d, e, f = "IDB_TRANSACTION_TAG_UNKNOWN") {
    Ad("TRANSACTION_ENDED", {
        objectStoreNames: d,
...
var Zd = class {
    ...
    delete(a) {
        return a instanceof IDBKeyRange ? de(this, a) : W(this.h.delete(a))
    }
    get(a) {
    ...
    index(a) {
        try {
            return new ee(this.h.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new Id(a, this.h.name);
            throw b;
        }
    }
    getName() {
...
function ce(a) {
    return W(a).then(b => b ? new ge(a, b) : null)
}
var ge = class {
    constructor(a, b) {
        this.request = a;
    ...
    return new Promise((d, e) => {
        ...
        f.addEventListener("upgradeneeded", m => {
            try {
                ...
                m.dataLoss && "none" !== m.dataLoss && Ad("IDB_DATA_CORRUPTED", {
                    reason: m.dataLossMessage || "unknown reason",
                    dbName: Dd(a)
                });
                const v = t(),
                    w = new Vd(f.transaction);
...
var le = class {
    ...
    delete(a = {}) {
        return je(this.name, a)
    }
    open() {
        if (!this.l) throw ke(this);
            ...
            d = () => D(this, function*() {
                try {
                    ...
                    a: {
                        var f = e,
                            g = this.options;
                        for (const k of Object.keys(g.O)) {
                            const {
                                L: l,
                                Ea: n = Number.MAX_VALUE
                            } = g.O[k];
                    ...
                    if (void 0 !== h) {
                        if (!this.j) return this.j = !0, yield this.delete(), zd(new U("DB_DELETED_BY_MISSING_OBJECT_STORE", {
                            dbName: this.name,
                            qa: h
                        })), d();
                        throw new Hd(h);
                    ...
                    if (k instanceof DOMException ? "VersionError" === k.name : "DOMError" in self && k instanceof DOMError ? "VersionError" === k.name : k instanceof Object && "message" in k && "An attempt was made to open a database using a lower version than the existing version." === k.message) {
                        ...
                        h = e.h.version;
                        if (void 0 !== this.options.version && h > this.options.version + 1) throw e.close(), this.l = !1, ke(this, h);
                        return e
                    }
                    b();
                    throw k;
...
function ne(a) {
    return D(this, function*() {
        return X(yield me.open(), ["databases"], {
            D: !0,
            mode: "readwrite"
        }, b => {
...
function oe(a) {
    return D(this, function*() {
        if (a) return (yield me.open()).delete("databases", a)
    })
};
let pe;
const qe = new class {
...
function ve(a, b, c, d) {
    return D(this, function*() {
        ...
        try {
            return yield ne(e), yield ie(e.actualName, b, d)
        } catch (f) {
            try {
                yield oe(e.actualName)
            } catch (g) {}
            throw f;
        }
    })
...
function ye(a, b = {}) {
    return D(this, function*() {
        if (yield te()) {
            Cd(a);
            var c = ue(a);
            yield je(c.actualName, b);
            yield oe(c.actualName)
        }
    })
}
...
function ze(a, b = {}) {
    return D(this, function*() {
        if (yield te()) Cd(a), yield je(a, b), yield oe(a)
    })
};
const Ae = q("ytPubsub2Pubsub2Instance") || new H;
H.prototype.subscribe = H.prototype.subscribe;
H.prototype.unsubscribeByKey = H.prototype.J;
H.prototype.publish = H.prototype.H;
H.prototype.clear = H.prototype.clear;
u("ytPubsub2Pubsub2Instance", Ae);
...
var Ce = class extends le {
    ...
    i(a, b, c = {}) {
        return (this.options.W ? xe : we)(a, b, Object.assign({}, c))
    }
    delete(a = {}) {
        return (this.options.W ? ze : ye)(this.name, a)
    }
};
const De = ["client.name", "client.version"];

function Ee(a) {
    if (!a.errorMetadata || !a.errorMetadata.kvPairs) return a;
    a.errorMetadata.kvPairs = a.errorMetadata.kvPairs.filter(b => b.key ? De.includes(b.key) : !1);
    return a
};
var Fe;
Fe = Be("ServiceWorkerLogsDatabase", {
    O: {
        ["SWHealthLog"]: {
            L: 1
        }
...
function Ge(a) {
    return D(this, function*() {
        var b = yield Fe().open(), c = b.put, d = M("INNERTUBE_CONTEXT_CLIENT_NAME", 0);
        const e = Object.assign({}, a);
        e.clientError && (e.clientError = Ee(e.clientError));
        e.interface = d;
        return c.call(b, "SWHealthLog", e)
    })
};
const He = p.ytNetworklessLoggingInitializationOptions || {
    isNwlInitialized: !1,
    databaseToken: void 0,
    potentialEsfErrorCounter: 0,
    isIdbSupported: !1
};
u("ytNetworklessLoggingInitializationOptions", He);

function od(a, b, c) {
    !M("VISITOR_DATA") && .01 > Math.random() && Hc(new nc("Missing VISITOR_DATA when sending innertube request.", "log_event", b, c));
    if (!a.isReady()) throw a = new nc("innertube xhrclient not ready", "log_event", b, c), Gc(a), a;
    const d = {
        headers: {
    ...
    a.config_.na && d.headers.Authorization || (f.key = a.config_.innertubeApiKey);
    const g = Rc(`${b}${e}`, f || {}, !0),
        h = () => {
            try {
                Uc(g, d)
            } catch (k) {
                if ("InvalidAccessError" == k.name) Hc(Error("An extension is blocking network request."));
                else throw k;
            }
        };
    O("use_new_nwl") || q("ytNetworklessLoggingInitializationOptions") && He.isNwlInitialized ? se().then(k => {
        h(k)
    }) : h(!1)
}
class Ie {
    constructor(a) {
        this.config_ = null;
        a ? this.config_ = a : vd() && (this.config_ = ld())
    }
    isReady() {
        !this.config_ && vd() && (this.config_ = ld());
        return !!this.config_
    }
};
let Je = Ie;
...
function Ke(a, b, c = {}) {
    let d = Je;
    M("ytLoggingEventsDefaultDisabled", !1) && Je == Ie && (d = null);
    qd(a, b, d, c)
};
const Le = [{
    ...
    S: {
        Error: [{
            s: /(Permission denied) to access property "([^']+)"/,
            groups: ["reason", "key"]
        }],
        TypeError: [{
            s: /Cannot read property '([^']+)' of (null|undefined)/,
            groups: ["key", "value"]
        }, {
            s: /\u65e0\u6cd5\u83b7\u53d6\u672a\u5b9a\u4e49\u6216 (null|undefined) \u5f15\u7528\u7684\u5c5e\u6027\u201c([^\u201d]+)\u201d/,
            groups: ["value", "key"]
        }, {
            s: /\uc815\uc758\ub418\uc9c0 \uc54a\uc74c \ub610\ub294 (null|undefined) \ucc38\uc870\uc778 '([^']+)' \uc18d\uc131\uc744 \uac00\uc838\uc62c \uc218 \uc5c6\uc2b5\ub2c8\ub2e4./,
            groups: ["value", "key"]
        }, {
            s: /No se puede obtener la propiedad '([^']+)' de referencia nula o sin definir/,
            groups: ["key"]
        }, {
            s: /Unable to get property '([^']+)' of (undefined or null) reference/,
            groups: ["key", "value"]
        }, {
            s: /(null) is not an object \(evaluating '(?:([^.]+)\.)?([^']+)'\)/,
    ...
    S: {
        TypeError: [{
            ...
            s: /([^ ]+) called on (null or undefined)/,
            groups: ["key", "value"]
        }, {
            s: /Object (.*) has no method '([^ ]+)'/,
            groups: ["base", "key"]
        }, {
            s: /Object doesn't support property or method '([^ ]+)'/,
            groups: ["key"]
        }, {
            s: /\u30aa\u30d6\u30b8\u30a7\u30af\u30c8\u306f '([^']+)' \u30d7\u30ed\u30d1\u30c6\u30a3\u307e\u305f\u306f\u30e1\u30bd\u30c3\u30c9\u3092\u30b5\u30dd\u30fc\u30c8\u3057\u3066\u3044\u307e\u305b\u3093/,
            groups: ["key"]
        }, {
            s: /\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,
            groups: ["key"]
        }]
    }
}, {
    V: a => `${a.key} is not defined`,
    S: {
        ReferenceError: [{
            s: /(.*) is not defined/,
            groups: ["key"]
        }, {
            s: /Can't find variable: (.*)/,
            groups: ["key"]
        }]
    }
}];
...
function Ve(a, b, c, d) {
    if (a)
        if (Array.isArray(a)) {
            var e = d;
            for (d = 0; d < a.length && !(a[d] && (e += We(d, a[d], b, c), 500 < e)); d++);
            d = e
        ...
        for (e in a) {
            if (a[e]) {
                ...
                var g = a[e],
                    h = b,
                    k = c;
                f = "string" !== typeof g || "clickTrackingParams" !== f && "trackingParams" !== f ? 0 : (g = Te(atob(g.replace(/-/g, "+").replace(/_/g, "/")))) ? We(`${f}.ve`, g, h, k) : 0;
                d += f;
                d += We(e, a[e], b, c);
                if (500 < d) break
            }
        } else c[b] = Xe(a), d += c[b].length;
    else c[b] = Xe(a), d += c[b].length;
    return d
}
...
var Ye = new Set,
    ...
    af = 0,
    bf = [];
const cf = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];

function df(a) {
    ef(a)
}

function ef(a, b = "ERROR") {
    var c = {};
    ...
    if (a) {
        ...
        if (!(5 <= Ze)) {
            ...
            if (a.hasOwnProperty("args") && a.args && a.args.length)
                for (var h = 0; h < a.args.length && !(w = Ve(a.args[h], `params.${h}`, b, w), 500 <= w); h++);
            ...
            if (bf.length)
                for (h = 0; h < bf.length && !(w = Ve(bf[h], `params.context.${h}`, b, w), 500 <= w); h++);
            ...
            if ("IGNORED" === a.level) var k = 0;
                ...
                a = Oe();d = b;
                for (k of a.C)
                    if (d.message && d.message.match(k.pa)) {
                        k = k.weight;
                        break a
                    }
                for (var l of a.A)
            ...
            k.params || (k.params = {});
            n = Oe();
            k.params["params.errorServiceSignature"] = `msg=${n.C.length}&cb=${n.A.length}`;
            ...
            if (0 !== k.sampleWeight && !Ye.has(k.message)) {
                "ERROR" === c ? (Se.H("handleError", k), O("record_app_crashed_web") && 0 === af && 1 === k.sampleWeight && (af++, Ke("appCrashed", {
                    appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                })), $e++) : "WARNING" === c && Se.H("handleWarning", k);
                b: {
                    for (t of cf)
                        if ((n = sa) && 0 <= n.toLowerCase().indexOf(t.toLowerCase())) {
                            var t = !0;
                            break b
                        }
                    t = !1
                ...
                m && (Ke("clientError", m), ("ERROR" ===
                    c || O("errors_flush_gel_always_killswitch")) && gd());
                try {
                    Ye.add(k.message)
                } catch (z) {}
                Ze++
...
function gf(a) {
    return D(a, function*() {
        ...
        a: {
            ...
            for (let c = 0; c < b.length; c++)
                if (b[c][0] === (new wc).constructor.ba) {
                    b = new wc(b[c]);
                    break a
                }
            b = null
...
function hf(a = !1) {
    return D(jf.h, function*() {
        if (a || !this.h) this.h = gf(this).then(this.j).catch(b => {
            delete this.h;
            ef(b)
        });
        return this.h
...
let of = p.ytLoggingDocDocumentNonce_;
if (! of ) {
    var pf;
    a: {
        ...
        if (nf) {
            let d = 1;
            for (let e = 0; e < nf.length; e++) c[d % 16] = c[d % 16] ^ c[(d - 1) % 16] / 4 ^ nf.charCodeAt(e), d++
        }
        pf = c
    }
    const a = pf,
...
function sf() {
    ...
    if (!a) return ef(Error("Error: No InnerTubeContext shell provided in ytconfig.")), {};
    a = la(a);
...
var uf = class {};
const vf = {
    ["GET_DATASYNC_IDS"]: class extends uf {}
};
...
function wf(a) {
    ...
    if (void 0 !== xf.h) {
        ...
        if (a.some(e => e)) throw new nc("InnerTubeTransportService is already initialized", a);
...
function yf(a, b, c) {
    return D(a, function*() {
        ...
        if (this.i.sa) {
            ...
            d = Object.assign(Object.assign({}, zf(c)), d)
        } else d = Af(this, b, c);
        return d
    })
}
...
function Bf(a, b, c) {
    var d, e;
    return D(a, function*() {
        for (var f of []) f.Da(b.G.context);
        if (null === (d = this.h) || void 0 === d ? 0 : d.l(b.input, b.G)) return this.h.j(b.input, b.G);
        f = JSON.stringify(b.G);
        b.T = Object.assign(Object.assign({}, b.T), {
            headers: c
        });
        let g = Object.assign({}, b.T);
        "POST" === b.T.method && (g = Object.assign(Object.assign({}, g), {
            body: f
        }));
...
function Cf(a, b, c) {
    ...
    b.context || (b.context = sf());
    return new F(e => D(a, function*() {
        var f = tf(c);
        f = Sc(f) ? "same-origin" : "cors";
        f = yield yf(this, d, f);
        var g = tf(c);
        M("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT") && (null === f || void 0 === f ? 0 : f.Authorization) || (g = Rc(g, {
...
function Af(a, b, c) {
    ...
    return D(a, function*() {
        var e = {
            sessionIndex: null === (d = null === b || void 0 === b ? void 0 : b.Y) || void 0 === d ? void 0 : d.sessionIndex
        };
        e = yield Vb(kf(e));
        return Promise.resolve(Object.assign(Object.assign({}, zf(c)), e))
    })
}
...
var xf = class {
    constructor(a, b, c) {
        ...
        this.h = void 0;
        a.X || (a.X = {});
        a.X = Object.assign(Object.assign({}, vf), a.X)
    }
};
let Df;
...
function Gf(a) {
    D(this, function*() {
        var b = yield te();
        O("nwl_sw_health_payloads") && b ? yield Ge(a): (yield hf(), b = {
            ...
            options: b
        } : void 0, b && Ke(b.payloadName, b.payload))
    })
}
...
function If(a) {
    ...
    a = b.type;
    b = b.data;
    "notifications_register" === a ? (I("IDToken", b), Jf()) : "notifications_check_registration" === a && Kf(b)
}
...
function Nf(a) {
    return D(this, function*() {
        const b = Mf(a.payload.chrome.extraUrlParams),
            c = {
            ...
            d = uc(ic);
        return Of().then(e => Cf(e, c, d).then(f => {
            f.json().then(g => {
                if (!g || !g.endpointUrl) return Promise.resolve();
                a.payload.chrome.postedEndpoint && Pf(a.payload.chrome.postedEndpoint);
                return Qf(a, g.endpointUrl)
            })
        }))
    })
}
...
function Kf(a) {
    const b = [Sf(a), J("RegistrationTimestamp").then(Tf), Uf(), Vf(), Wf()];
    Promise.all(b).catch(() => {
        I("IDToken", a);
        Jf();
...
function Vf() {
    return J("Endpoint").then(a => Xf().then(b => a === b ? Promise.resolve() : Promise.reject()))
}

function Wf() {
    return J("application_server_key").then(a => Yf().then(b => a === b ? Promise.resolve() : Promise.reject()))
}
...
function Jf() {
    ...
    Promise.all([Xf(), $f(), ag(), Yf()]).then(([a, b, c, d]) => {
        b = b ? lc(b) : null;
        c = c ? lc(c) : null;
        d = d ? Ea(new Uint8Array(d), 4) : null;
        bg(a, b, c, d)
    }).catch(() => {
        bg()
    })
...
function bg(a = null, b = null, c = null, d = null) {
    qc().then(e => {
        e && (I("Endpoint", a), I("P256dhKey", b), I("AuthKey", c), I("application_server_key", d), I("Permission", Notification.permission), Promise.all([J("DeviceId"), J("NotificationsDisabled")]).then(([f, g]) => {
            if (null !== f && void 0 !== f) var h = f;
                ...
                var k;
                h = h || hc.length;
                for (k = 0; 256 > k; k++) f[k] = hc[0 | Math.random() * h];
                h = f.join("")
            }
            cg(h, null !== a && void 0 !== a ? a : void 0, null !== b && void 0 !== b ? b : void 0, null !== c && void 0 !== c ? c : void 0, null !== d && void 0 !== d ? d : void 0, null !==
                g && void 0 !== g ? g : void 0)
        }))
    })
}
...
function cg(a, b, c, d, e, f) {
    D(this, function*() {
        const g = {
            ...
            h = uc(kc);
        return Of().then(k => Cf(k, g, h).then(() => {
            I("DeviceId", a);
...
function eg(a) {
    return D(this, function*() {
        dg || (dg = yield a.open("yt-appshell-assets"));
        return dg
    })
}
...
function fg(a, b) {
    return D(this, function*() {
        const c = yield eg(a), d = b.map(e => gg(c, e));
...
function ig(a, b) {
    return D(this, function*() {
        const c = yield eg(a), d = (yield c.keys()).filter(e => !b.includes(e.url)).map(e => c.delete(e));
        return Promise.all(d)
    })
}
...
function jg(a, b, c) {
    return D(this, function*() {
        yield(yield eg(a)).put(b, c)
    })
}

function kg(a, b) {
    D(this, function*() {
        yield(yield eg(a)).delete(b)
    })
}
...
var Z;
Z = Be("yt-serviceworker-metadata", {
    O: {
        ["auth"]: {
            L: 1
        },
    ...
    W: !0,
    upgrade(a, b) {
        b(1) && Yd(a, "resource-manifest-assets");
        b(2) && Yd(a, "auth")
    },
    version: 2
});
...
function mg() {
    return D(ng, function*() {
        const a = yield te();
        if (a) return ng.h || (ng.h = new ng(a)), ng.h
    })
}
...
function pg(a, b) {
    return D(a, function*() {
        let c = !1,
            d = 0;
        yield X(yield Z().open(), ["resource-manifest-assets"], "readonly", e => be(e.objectStore("resource-manifest-assets"), {
            query: IDBKeyRange.bound(0, Date.now()),
            direction: "prev"
        }, f => {
...
function qg(a) {
    return D(a, function*() {
        lg || (yield X(yield Z().open(), ["resource-manifest-assets"], "readonly", b => be(b.objectStore("resource-manifest-assets"), {
            query: IDBKeyRange.bound(0, Date.now()),
            direction: "prev"
        }, c => {
            lg = c.getKey()
...
function rg() {
    return D(sg, function*() {
        const a = yield te();
        if (a) return sg.h || (sg.h = new sg(a)), sg.h
    })
}
...
function xg(a, b) {
    for (; Qa(b);) switch (b.m) {
        case 10:
            ...
            var f = c.i,
                g = d;
            if (Aa) d = f, c = e, f = g, (e = za) || (e = za = new TextDecoder("utf-8", {
                fatal: !1
                ...
                for (; e < g;) k = f[e++], 128 > k ? l.push(k) : 224 > k ? e >= g ? l.push(65533) : (h = f[e++], 194 > k || 128 !== (h & 192) ? (e--, l.push(65533)) : l.push((k & 31) << 6 | h & 63)) : 240 > k ? e >= g - 1 ? l.push(65533) : (h = f[e++], 128 !== (h & 192) || 224 === k && 160 > h || 237 === k && 160 <= h || 128 !== ((c = f[e++]) & 192) ?
                    (e--, l.push(65533)) : l.push((k & 15) << 12 | (h & 63) << 6 | c & 63)) : 244 >= k ? e >= g - 2 ? l.push(65533) : (h = f[e++], 128 !== (h & 192) || 0 !== (k << 28) + (h - 144) >> 30 || 128 !== ((c = f[e++]) & 192) || 128 !== ((d = f[e++]) & 192) ? (e--, l.push(65533)) : (h = (k & 7) << 18 | (h & 63) << 12 | (c & 63) << 6 | d & 63, h -= 65536, l.push((h >> 10 & 1023) + 55296, (h & 1023) + 56320))) : l.push(65533), 8192 <= l.length && (n = ya(n, l), l.length = 0);
                d = ya(n, l)
            }
            kb(a, 1, d);
            break;
...
function zg(a) {
    a: {
        var b = new Ag;
        for (a = new Sa(a); Qa(a);) switch (a.m) {
            case 10:
                var c = b,
                    d = a,
                    e = new yg,
...
function Cg(a) {
    return D(this, function*() {
        ...
        return b ? Promise.resolve(Dg(b)) : Promise.reject(Error("No resource manifest header"))
    })
}

function Dg(a) {
    return nb(zg(decodeURIComponent(a)), yg, 1).reduce((b, c) => {
        (c = C(c, 1)) && b.push(c);
        return b
    }, [])
};
...
function Eg(a) {
    return D(a, function*() {
        ...
        if (b && null != C(b, 3)) {
            var c = yield rg();
            c && (c = yield ug(c), C(b, 3) !== c && (kg(this.h, this.i), wg()))
        }
    })
}
...
function Fg(a) {
    return D(a, function*() {
        let b, c;
        try {
            c = yield Gg(this, this.j), b = yield Cg(c), yield fg(this.h, b)
        } catch (d) {
            return Promise.reject(d)
        }
        try {
            yield Hg(this), yield jg(this.h, this.i, c)
        } catch (d) {
            return Promise.reject(d)
        }
        if (b) try {
            yield Ig(this, b, this.i)
        } catch (d) {}
        return Promise.resolve()
    })
}
...
function Hg(a) {
    return D(a, function*() {
        ...
        return c ? (b = yield rg()) ? Promise.resolve(tg(b, c)) : Promise.reject(Error("Could not get AuthMonitor instance")) : Promise.reject(Error("Could not get datasync ID"))
    })
}
...
function Qg(a, b) {
    return D(a, function*() {
        ...
        const d = yield Lg(this.h);
        if (d) return Sg(this), d;
        Tg(this);
...
function Vg(a, b) {
    return D(a, function*() {
        const c = yield Lg(this.h);
        if (!c) return Tg(this), Pg(b);
        Sg(this);
        var d;
        a: {
...
var Zg = ["/", "/feed/downloads"];
const bh = [/^\/$/, /^\/feed\/downloads$/],
    ch = [/^\/$/, /^\/feed\/\w*/, /^\/results$/, /^\/playlist$/, /^\/watch$/, /^\/channel\/\w*/];

function $g() {
    return new RegExp((O("kevlar_sw_app_wide_fallback") ? ch : bh).map(a => a.source).join("|"))
}
var Xg = /^https:\/\/[\w-]*\.?youtube\.com.*(\.css$|\.js$|\.ico$|\/ytmweb\/_\/js\/|\/ytmweb\/_\/ss\/)/,
    Yg = /^https:\/\/[\w-]*\.?youtube\.com.*(purge_shell=1|\/signin|\/logout)/;
var dh = class {
    constructor() {
        var a = Wg,
            b = new ah;
    ...
    l(a) {
        return D(this, function*() {
            ...
            const d = a.request;
            if (b.o.test(d.url)) jf.h && (delete jf.h.h, p.__SAPISID = void 0, L("VISITOR_DATA", void 0), L("SESSION_INDEX", void 0), L("DELEGATED_SESSION_ID", void 0)), c = a.respondWith, b = b.h, kg(b.h, b.i), wg(), b = Pg(a), c.call(a, b);
            else if (b.m.test(d.url)) a.respondWith(Ng(b,
                a));
                ...
                e ? a.respondWith(Qg(b, a)) : Ug(b, d.url) ? a.respondWith(Vg(b, a)) : c && a.respondWith(Pg(a))
            }
        })
    }
    u(a) {
        const b = a.data;
        this.H.includes(b.type) ? If(a) : "refresh_shell" === b.type && Fg(this.i).catch(c => {
            Y(c)
        })
    }
};
...
function eh() {
    ...
    a || (a = new fh, u("ytglobal.storage_", a));
    return a
}
var fh = class {
    estimate() {
        ...
        return D(this, function*() {
            ...
            if (null === (b = c.webkitTemporaryStorage) || void 0 === b ? 0 : b.queryUsageAndQuota) return gh()
        })
    }
};
...
function hh(a, b) {
    eh().estimate().then(c => {
        c = Object.assign(Object.assign({}, b), {
            isSw: void 0 === self.document,
            isIframe: self !== self.top,
            deviceStorageUsageMbytes: ih(null === c || void 0 === c ? void 0 : c.usage),
            deviceStorageQuotaMbytes: ih(null === c || void 0 === c ? void 0 : c.quota)
        });
...
class jh {
    constructor() {
        ...
        this.j = Math.random() <= Bc("ytidb_transaction_ended_event_rate_limit", .02)
    }
    N(a, b) {
        switch (a) {
...
for (T = new jh; 0 < S.length;) {
    ...
    switch (a.type) {
        case "ERROR":
            ...
            break;
        case "EVENT":
            T.N(a.eventType, a.payload)
    }
}
jf.h = new jf(`${self.location.origin}/sw.js_data`);
