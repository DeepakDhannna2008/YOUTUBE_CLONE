(function() {
    ...
    */
    ...
    function ra(a) {
        if (a instanceof qa && a.constructor === qa) return a.g;
        var b = typeof a;
    ...
    function xa(a, b) {
        if (a.tagName && va[a.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " + a.tagName + ".");
        if (wa())
    ...
    function gb(a, b) {
        var c = K[a];
        if (c && (kb(c), 0 < c.G && c.items.length)) {
            var d = c.items[0];
            d && (a = n(function(e, f) {
                f();
                e()
            }, null, n(gb, null, a, b)), b ? (c.items.shift(), a(d.I)) : lb(c, d, a))
        }
    }

    function lb(a, b, c) {
        b.delay ? (c = n(c, null, za), a.v = setTimeout(c, b.delay), b.delay = 0) : (a.items.shift(), c = n(c, null, b.I), (b = (b = A["advanced-task-scheduler"]) && b.addTask) ? a.A = b(c) : a.v = setTimeout(c, 0))
    }
    ...
    function pb(a, b, c, d) {
        ...
        c && (h = Q[P(a, c)]) && b != h && (p(e ? "spfjsbeforeunload" : "spfcssbeforeunload", {
            name: c,
            url: h
        }), e = h, delete Q[P(a, c)], e && delete S[P(a, e)], delete G[P(a, c)], db(g, n(qb, null, a, c, h)));
        if ((e = S[P(a, b)]) && f != e) {
            delete Q[P(a, e)];
            delete S[P(a, b)];
            var k = P(a, e);
        ...
        db(g, d);
        d = n(rb, null, a);
        T[P(a, b, void 0)] ? (e && f != e && (a = sb(a, b)) && a.setAttribute("name", c || ""), d()) : (a = tb(a, b, d, void 0,
            void 0, h)) && c && a.setAttribute("name", c)
    }
    ...
    function rb(a) {
        var b = P(a, ""),
            c;
        for (c in G) 0 == c.indexOf(b) && Aa(c.substring(b.length).split("|"), n(wb, null, a)) && fb(c)
    }
    ...
    function Db(a, b, c) {
        ...
        f = "hash-" + g;
        Q[P(a, c)] = f;
        !Eb(a, f) && (b = Fb(a, b)) && (T[P(a, f, void 0)] = 2, b && !d && (d = xb(f), b.className = P(a, d), b.setAttribute("name", c)), (e = e && e[0]) && vb(a, e))
    }
    ...
    function V(a, b, c, d) {
        ...
        b.attr && (u = n(function(t, C) {
            for (var H in t) {
                ...
                if (M) {
                    ...
                    for (R in $b) {
                        var ua = $b[R];
                        "class" == R ? M.className = ua : "style" == R ? M.style.cssText = ua : (M.setAttribute(R, ua), "value" == R && (M[R] = ua))
                    }
                }
            }
            C.spfProcessAttr = q()
        ...
        for (Wa in I) u = n(function(t, C) {
            if (t = document.getElementById(t)) {
                ...
                C = A["animation-class"];
                ac && Ta(t, C) ?
                    (t = new bc(t, H.html, C, k, !!f), hb(m), L(t.key, !0), J(t.key, n(cc, null, t), 0), J(t.key, n(dc, null, t), 17), J(t.key, n(ec, null, t), t.duration), J(t.key, n(function() {
                        M();
                        ib(m, B)
                    }, null), 0), L(t.key)) : (C = A["experimental-html-handler"]) ? (hb(m), C(H.html, t, function() {
                        M();
                        ib(m, B)
                    })) : (xa(t, sa(H.html)), M())
            }
    ...
    function W(a) {
        var b = new ic;
        if (!a) return b;
        if (!Ea(a)) return a.scripts && r(a.scripts, function(c) {
            b.scripts.push({
                url: c.url || "",
                text: c.text || "",
                name: c.name || "",
        ...
        a = a.replace(jc, function(c, d, e, f) {
            ...
            return "style" == d && (d = (d = e.match(kc)) ? d[1] : "", e = nc.exec(e), e = !e || -1 != e[1].indexOf("text/css")) ? (b.styles.push({
                url: "",
                text: f,
                name: d
            }), "") : c
        ...
        a = a.replace(oc, function(c, d) {
            ...
            return "stylesheet" == e ? (e = (e = d.match(kc)) ? e[1] : "", d = (d = d.match(qc)) ? d[1] : "", b.styles.push({
                ...
                text: "",
                name: e
            }), "") : "spf-preconnect" == e ? (d = (d = d.match(qc)) ? d[1] : "", b.links.push({
                url: d,
                rel: e
            }), "") : c
        });
    ...
    */
    ...
    function Ic(a) {
        if (!a.defaultPrevented) {
            var b = Ec(a);
            b && (b = ob(b), Fc(b) && Gc() && p("spfclick", {
                url: b,
                target: a.target
            }) && (Jc(b, {}, new Kc), a.preventDefault()))
        }
    }
    ...
    function Pc(a, b) {
        ...
        Fc(a) ? Gc() ? p("spfhistory", {
            ...
            referer: b.i,
            previous: b.current
        }) && (b.position && (w("nav-scroll-position", [window.pageXOffset, window.pageYOffset]), w("nav-scroll-url", window.location.href)), Jc(a, {}, b)) : X(a, "1") : X(a, "9")
    }
    ...
    function Yc(a, b) {
        if (b.position) Oc(), window.scroll.apply(null, b.position), b.s = !0;
        else if (a = z(a, "#"), a[2]) {
            if (a = document.getElementById(a[2])) Oc(), a.scrollIntoView(), b.s = !0
        } else b.s || (Oc(), window.scroll(0, 0), b.s = !0)
    }
    ...
    function bd(a, b) {
        try {
            b += window.location.hash, Za(b, null, !0)
        } catch (c) {
            Qc(), Y(a, b, c)
        }
    }
    ...
    function hd(a, b, c, d, e) {
        if (ad(d, e, b, !0)) {
            ...
            if (e.redirect) ld(a, b, c, e.redirect);
            else {
                if (a) {
    ...
    var od = {
            ...
            navigate: function(a, b) {
                a && (a = ob(a), Fc(a) ? Gc() ? Jc(a, b || {}, new Kc) : X(a, "1") : X(a, "9"))
            },
            load: function(a, b) {
                a = ob(a);
                fd(a, b || {}, new Kc)
